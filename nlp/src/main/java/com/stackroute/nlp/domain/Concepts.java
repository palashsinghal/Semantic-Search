...
public class Concepts {
	...
	private List<String> StopWords = Arrays.asList("interface", "abstraction", "polymorphism", "encapsulation", "method",
			"thread", "string", "inheritance", "class","jdk", "jre", "jvm", "nio", "abstract class", "inner class", 
			"merge sort", "bubble sort", "quick sort", "radix sort", "testing", "object", "ajax", "jquery");
